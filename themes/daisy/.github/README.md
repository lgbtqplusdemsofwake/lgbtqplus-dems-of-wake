...
> You can find this theme on [Codeberg](https://codeberg.org/winterstein/zola-theme-daisy) as well. I prefer to receive issue reports and contributions there, but feel free to also open issues or pull-requests here.
...
![DaisyUI Color Themes](../daisyui-themes.png)
...
For starting to create a new Zola website using this theme, the you can also just checkout / fork the [example repository](https://github.com/awinterstein/zola-theme-daisy-example) and adapt it to your needs. That repository already contains a structure and configuration for the Zola-based website.
...
Just be aware, that you need to add a [Lunr Languages](https://github.com/MihaiValentin/lunr-languages) file to your `static` directory, if you ae using other languages than English and German. See the corresponding repository for the [`min` files](https://github.com/MihaiValentin/lunr-languages/tree/master/min). Feel free to add support for your languages to the theme as well, via a [pull-request](https://github.com/awinterstein/zola-theme-daisy/pulls).
